...
$result = $conn->query("SELECT * FROM products WHERE category = 'milkshake'");
...
<head>
    ...
    <style>
        body {
            ...
            background-color: rgb(245, 212, 240);
            margin: 0;
            padding: 20px;
            text-align: center;
        }
...
<body>
    ...
    <div class="navbar">
        ...
        <h2>Milkshakes Are Ready Sip It Now</h2>
            ...
            <div class="product">
                ...
                <?php if ($user_id): ?>
                    <form action="add_to_cart.php" method="POST">
                        ...
                        <input type="hidden" name="redirect" value="milkshakes.php">
